                ...
                <div className="w-70-l">
                  {employments.map((employment, ind) => (
                    <TransitionComponent
                      key={ind}
                      index={ind}
                      idToShow={employment_id_to_show}
                    >
      ...
      <div className="flex flex-column-reverse-l flex-row-reverse justify-end content-end">
        {employments.map((employment, ind) => (
          <div
            ...
            className={`pl3-l pv2-l pa3-m pa3-ns pa3 pointer bl-l bb-0-l bb bw2-l bw2 tc font-ubuntu-mono transition-ease-in ${
...
const RoleCompany = ({ employment }) => {
  ...
  return (
    <div className="mb0 mt0 f4">
      ...
      &nbsp;
      <span className="employment-symbol">@</span>
      &nbsp;
      <span className="employment-company">{finalizedCompanyName}</span>
    </div>
  );
};
...
const DateOfService = ({ employment }) => {
  ...
  return (
    <h4 className="mt2 desc font-ubuntu-mono">
      {`${start_date.toLocaleString("en-US", date_options)} - ${
        end_date === null
          ? "Present"
