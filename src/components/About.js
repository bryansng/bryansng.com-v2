  ...
  render() {
    ...
    return (
      <div id="about">
        <SlideIn>
          <PaddingResizer>
            <div className="w-two-thirds-l w-75 center tl">
              <div className="pv3">
                <TabContent
                ...
                <div className="w-70-l">
                  ...
                  <div className="flex flex-row flex-nowrap justify-between">
                    {categories.map((category, ind) => (
                      <div
                        key={ind}
                        className={`pa3 pointer bb bw2 tc paragraph font-ubuntu-mono transition-ease-in ${
                          ind === category_id_to_show
                            ? "active-about"
                            : "not-active-about"
                        }`}
...
const TransitionComponent = props => {
  ...
  return (
    <div
      className={`${
        index === idToShow
          ? "left-0 top-0 relative o-100 transition-ease-in-05"
          : "absolute hide o-0"
      }`}
    >
      {props.children}
